...
public class JAXBExample {
	...
	public static void doJAXBXml() throws Exception {
		...
		// Marshall Course object and write to the StringWriter
		marshaller.marshal(course, stringWriter);
		// Get String from StringWriter
		...
		Course unmarshallerCourse = unmarshaller.unmarshal(streamSource,Course.class).getValue();
		System.out.println("---------------\nUnmarshalled course name - " + unmarshallerCourse.getName());
		stringReader.close();
	}
